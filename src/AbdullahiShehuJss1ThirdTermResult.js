...
<div className="printable-area">
  ...
  const AbdullahiShehuJss1ThirdTermResult = ({score}) => {
    ...
    const Js1FirstEngTestScore = parseInt(localStorage.getItem("Js1FirstEngTestScore"))  || 0;
    ...
    const totalScore = Js1FirstEngTestScore + Js1EngTopicOneToOneScore + Js1FirstEnglishExamScore;
    ...
    const dataArray1 = [
        ...
        { column1: 'English', column2: 'Data 7', column3: <div className="TextAlign">{Js1FirstEngTestScore}</div>, column4: <div className="TextAlign">{Js1EngTopicOneToOneScore}</div>, column5: <div className="TextAlign">{Js1FirstEnglishExamScore}</div>, column6: totalScore, column7: "" },
