...
<h4>Fill in the blank space with the most appropriate option</h4> */}
            <div className="GoodLuckButton">
                <button onClick={() => { window.location.href = "./economics";}}>start</button>
            </div>
        </div>
    </div>
    )
...
export default InstructionEconsExams