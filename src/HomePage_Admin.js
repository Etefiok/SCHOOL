...
const Homepage_Admin = ({ updateScore }) => {
  ...
  const [isRotatedOneToOneClickJSS1, setIsRotatedOneToOneClickJSS1] =
    useState(false);
  const [isRotatedOneToOneClickJSS2, setIsRotatedOneToOneClickJSS2] =
    useState(false);
  const [isRotatedOneToOneClickJSS3, setIsRotatedOneToOneClickJSS3] =
    useState(false);
  const [isRotatedOneToOneClickSSS1, setIsRotatedOneToOneClickSSS1] =
    useState(false);
  const [isRotatedOneToOneClickSSS2, setIsRotatedOneToOneClickSSS2] =
    useState(false);
  const [isRotatedOneToOneClickSSS3, setIsRotatedOneToOneClickSSS3] =
    useState(false);
  const [
    isRotatedOneToOneClicstudentname,
    setIsRotatedOneToOneClicstudentname,
  ] = useState(false);
  const [
    isRotatedOneToOneClicstudentnameJSS2,
    setIsRotatedOneToOneClicstudentnameJSS2,
  ] = useState(false);
  const [
    isRotatedOneToOneClicstudentnameJSS3,
    setIsRotatedOneToOneClicstudentnameJSS3,
  ] = useState(false);
  const [
    isRotatedOneToOneClicstudentnameSSS1,
    setIsRotatedOneToOneClicstudentnameSSS1,
  ] = useState(false);
  const [
    isRotatedOneToOneClicstudentnameSSS2,
    setIsRotatedOneToOneClicstudentnameSSS2,
  ] = useState(false);
  const [
    isRotatedOneToOneClicstudentnameSSS3,
    setIsRotatedOneToOneClicstudentnameSSS3,
  ] = useState(false);
  const [isRotatedOneToOneClicsubject01, setIsRotatedOneToOneClicsubject01] =
    useState(false);
  const [isRotatedOneToOneCli, setIsRotatedOneToOneCli] = useState(false);

  const [showAdditionalOneToOneArrow, setShowAdditionalOneToOneArrow] =
    useState(false);
  const [showAdditionalOneToOneArrow3, setShowAdditionalOneToOneArrow3] =
    useState(false);
  const [showAdditionalOneToOneArroJSS1, setShowAdditionalOneToOneArroJSS1] =
    useState(false);
  const [showAdditionalOneToOneArroJSS2, setShowAdditionalOneToOneArroJSS2] =
    useState(false);
  const [showAdditionalOneToOneArroJSS3, setShowAdditionalOneToOneArroJSS3] =
    useState(false);
  const [showAdditionalOneToOneArroSSS1, setShowAdditionalOneToOneArroSSS1] =
    useState(false);
  const [showAdditionalOneToOneArroSSS2, setShowAdditionalOneToOneArroSSS2] =
    useState(false);
  const [showAdditionalOneToOneArroSSS3, setShowAdditionalOneToOneArroSSS3] =
    useState(false);
  const [
    showAdditionalOneToOneArrostudentname,
    setShowAdditionalOneToOneArrostudentname,
  ] = useState(false);
  const [
    showAdditionalOneToOneArrosubject01,
    setShowAdditionalOneToOneArrosubject01,
  ] = useState(false);
  ...
  const [
    ...
    setIsRotatedTestClicstudentnameJSS2,
  ] = useState(false);
  const [
    isRotatedTestClicstudentnameJSS3,
    setIsRotatedTestClicstudentnameJSS3,
  ] = useState(false);
  const [
    isRotatedTestClicstudentnameSSS1,
    setIsRotatedTestClicstudentnameSSS1,
  ] = useState(false);
  const [
    isRotatedTestClicstudentnameSSS2,
    setIsRotatedTestClicstudentnameSSS2,
  ] = useState(false);
  const [
    isRotatedTestClicstudentnameSSS3,
    setIsRotatedTestClicstudentnameSSS3,
  ] = useState(false);
  const [isRotatedTestClicsubject01, setIsRotatedTestClicsubject01] =
    useState(false);
  ...
  const [showAdditionalTestArrow3, setShowAdditionalTestArrow3] =
    useState(false);
  const [showAdditionalTestArroJSS1, setShowAdditionalTestArroJSS1] =
    useState(false);
  const [showAdditionalTestArroJSS2, setShowAdditionalTestArroJSS2] =
    useState(false);
  const [showAdditionalTestArroJSS3, setShowAdditionalTestArroJSS3] =
    useState(false);
  const [showAdditionalTestArroSSS1, setShowAdditionalTestArroSSS1] =
    useState(false);
  const [showAdditionalTestArroSSS2, setShowAdditionalTestArroSSS2] =
    useState(false);
  const [showAdditionalTestArroSSS3, setShowAdditionalTestArroSSS3] =
    useState(false);
  const [
    showAdditionalTestArrostudentname,
    setShowAdditionalTestArrostudentname,
  ] = useState(false);
  ...
  const [isRotatedMediaClic, setIsRotatedMediaClic] = useState(false);
  const [isRotatedMediaClicJSS2, setIsRotatedMediaClicJSS2] = useState(false);
  const [isRotatedMediaClicJSS3, setIsRotatedMediaClicJSS3] = useState(false);
  const [isRotatedMediaClicSSS1, setIsRotatedMediaClicSSS1] = useState(false);
  const [isRotatedMediaClicSSS2, setIsRotatedMediaClicSSS2] = useState(false);
  const [isRotatedMediaClicSSS3, setIsRotatedMediaClicSSS3] = useState(false);
  // const [isRotatedClicsubject01, setIsRotatedClicsubject01] = useState(false);
  // const [isRotatedCli, setIsRotatedCli] = useState(false);

  const [showAdditionalMediaArrow, setShowAdditionalMediaArrow] =
    useState(false);
  const [showAdditionalMediaArrow3, setShowAdditionalMediaArrow3] =
    useState(false);
  const [showAdditionalMediaArroJSS1, setShowAdditionalMediaArroJSS1] =
    useState(false);
  const [showAdditionalMediaArroJSS2, setShowAdditionalMediaArroJSS2] =
    useState(false);
  const [showAdditionalMediaArroJSS3, setShowAdditionalMediaArroJSS3] =
    useState(false);
  const [showAdditionalMediaArroSSS1, setShowAdditionalMediaArroSSS1] =
    useState(false);
  const [showAdditionalMediaArroSSS2, setShowAdditionalMediaArroSSS2] =
    useState(false);
  const [showAdditionalMediaArroSSS3, setShowAdditionalMediaArroSSS3] =
    useState(false);
  const [showAdditionalMediaArro, setShowAdditionalMediaArro] = useState(false);
  // const [showAdditionalArrosubject01, setShowAdditionalArrosubject01] =
  //   useState(false);
        ...
        <Offcanvas show={show} onHide={handleClose}>
          ...
          <Offcanvas.Body>
            ...
            <div className="Side-menue-admin">
              ...
              {showAdditionalMediaArroJSS1 && (
                <div>
                  ...
                  <div>
                    {isRotatedMediaClic && (
                      <button
                        onClick={() => handleTabClick("EconomicsMedia")}
                        className={`sucbject01-additional-arrow-container ${
              ...
              <div className="dropdown-alert">
                <button
                  onClick={() => handleTabClick("AlertMessages")}
                  className={`sucbject01-additional-arrow-container ${
                    activeTab === "Galary" ? "active" : ""
                  }`}
                >
              ...
              >
                ...
                <div className="Side-menue-admin">
                  ...
                  <div className="dropdown-alert">
                    ...
                    >
                      <p className="arrow-arrow-text">Contact</p>
                    </button>
                  </div>
                  ...
                  <div className="dropdown-alert">
                    <button
                      onClick={() => handleTabClick("AdmissionList")}
                      className={`sucbject01-additional-arrow-container ${
                        activeTab === "Galary" ? "active" : ""
                      }`}
                    >
                      <p className="arrow-arrow-text">Admission List</p>
                    </button>
                  </div>
                {/* <div>
                    < ContactUsMessage />
