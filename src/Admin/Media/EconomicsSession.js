          ...
          <div className='VideoContainer'>
            <div className='Video-Image'>
                ...
                <Form.Group>
                    ...
                    type="file"
                    accept="video/*"
                    onChange={(e) => handleVideoChange2(currentQuestionIndex, e.target.files[0])}
          ...
          <div className="Preview-Section">
            <div>
              ...
              {currentQuestion.video && (
                <div>
                  <h3>Video</h3>
                  <video src={currentQuestion.video} controls style={{ maxWidth: '40%', width: '100%', height: 'auto' }} />
                </div>
              )}
              {currentQuestion.video2 && (
                <div>
                  <h3>Slide</h3>
                  <video src={currentQuestion.video2} controls style={{ maxWidth: '40%', width: '100%', height: 'auto' }} />
                </div>
              )}
              {currentQuestion.image && (
                <div>
                  <h3>Image:</h3>
                  <img src={currentQuestion.image} alt="Quiz" style={{ maxWidth: '40%', width: '100%', height: 'auto' }} />
                </div>
              )}
